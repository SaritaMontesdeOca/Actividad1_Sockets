...
void file (int socketfd, char *name, char *start, char *end)
{
  int fp;
  ...
  snprintf (ltostr, 200, "%u", total_parts);
  strcat (msj, ltostr);
  strcat (msj, "\n\r");
...
void fileinfo (int socketfd, char *name)
{
...
void filelist (int socketfd)
{
  ...
  snprintf (size_str, 200, "%i",(int) strlen (list));
  strcat (msj, size_str);
  strcat (msj, "\n\r");
